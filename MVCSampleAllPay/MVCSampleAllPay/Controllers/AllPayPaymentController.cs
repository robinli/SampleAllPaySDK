...
namespace MVCSampleAllPay.Controllers
{
    public class AllPayPaymentController : Controller
    {
        // GET: AllPayPayment
        public ActionResult CallBack()
        {
            string result=GetCheckOutFeedback();
            return Content(result);
        }
        private string GetCheckOutFeedback()
        {
